...
A FORTRAN script was then written which performed precisely the same task as the Python script, and again was ran 50 times to produce an average runtime.
