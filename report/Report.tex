...
The methods of integration used are explored in the next section, along with analysis of the differential cross sections to judge the effectiveness of numerical integration upon them. 


\section{Integration of the Differential $\frac{\d{\sigma}}{\d{\Omega}}$}
History.
