...
TODO: errors, why is resonance present, what is $\Gamma_{\Zzero}$, why does the interference term has the form it does, how do the differential cross sections change as $\sqrt{s}$ changes.
